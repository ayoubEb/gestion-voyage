...
<header>
  <h2>
    Fiche du salaire d'utilisateur :
    {{ $user->name }}
  </h2>
...
<table @class('table')>
  <tbody>
    <tr>
      ...
      <td><h5 @class(["m-0"])>{{ $user->cnie }}</h5></td>
    </tr>
    <tr>
