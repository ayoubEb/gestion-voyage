      ...
      <div @class(['d-flex','justify-content-between','mb-3','align-items-center'])>
        <div @class(['d-flex','align-items-center'])>
          ...
          <h4 @class(['m-0','ps-1','border','border-top-0','border-bottom-0','border-end-0','border-solid','border-3','border-info'])>
            Liste d'employés à l'intérieur
          </h4>
        </div>
        ...
        <table @class(['table','table-bordered','table-sm','m-0'])>
          ...
          <tbody>
            @forelse ($interieurs as $interieur)
              <tr>
                <td @class("align-middle")>{{ $interieur->name }}</td>
                <td @class("align-middle")>{{ $interieur->email }}</td>
                <td @class("align-middle")>{{ $interieur->telephone }}</td>
                <td @class("align-middle")>{{ $interieur->ville }}</td>
                <td @class("align-middle")>{{ $interieur->travail }}</td>
                <td @class("align-middle")>{{ $interieur->poste }}</td>
                <td @class("align-middle")>
                  <button type="button" @class(["btn","btn-sm","waves-effect","waves-light","btn-outline-info"]) data-bs-toggle="modal" data-bs-target=".edit{{'-'.$interieur->id }}">
                    <i @class(["mdi","mdi-pencil" ])></i>
                  </button>
                  <button type="button" @class(["btn","btn-sm","waves-effect","waves-light","btn-outline-info"]) data-bs-toggle="modal" data-bs-target=".del{{'-'.$interieur->id }}">
                    <i @class(["mdi","mdi-trash-can"])></i>
                  </button>
                  <button type="button" @class(["btn","btn-sm","waves-effect","waves-light","btn-outline-info"]) data-bs-toggle="modal" data-bs-target=".show{{'-'.$interieur->id }}">
                    <i @class(['mdi','mdi-information-outline'])></i>
                  </button>
                  <button type="button" @class(["btn","btn-sm","waves-effect","waves-light","btn-outline-info"]) data-bs-toggle="modal" data-bs-target=".salaire{{'-'.$interieur->id }}">
                    <i @class(['mdi','mdi-currency-usd'])></i>
                  </button>
                  <a href="{{ route('carte-travail',$interieur) }}" @class(["btn","btn-sm","btn-outline-info"])>
              ...
              {{-- modal edit --}}
              <div class="modal fade edit{{'-'.$interieur->id }}" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                  <div class="modal-content">
                    <div class="modal-header bg-info py-2">
                        <h5 class="modal-title text-white" id="myExtraLargeModalLabel">Modifier d'employé : {{ $interieur->name}}</h5>
                        {{-- <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button> --}}
                    </div>
                    <div class="modal-body">
                      <form action="{{ route('employe.update',$interieur) }}" method="post">
                        @csrf
                        @method('PUT')
                        <ul @class(["list-group"])>
                          <div @class(["row","row-cols-2"])>
                            ...
                            <div @class(["col","mb-1"])>
                              <li @class(["list-group-item","p-0"])>
                                <input type="text" name="cnie" id="" class="form-control  py-1" value="{{ $interieur->cnie }}">
                              </li>
                            </div>
                            <div @class(["col","mb-1"])>
                            ...
                            <div @class(["col","mb-1"])>
                              <li @class(["list-group-item","p-0"])>
                                <input type="text" name="name" id="" class="form-control py-1" value="{{ $interieur->name }}">
                              </li>
                            </div>
                            <div @class(["col","mb-1"])>
                            ...
                            <div @class(["col","mb-1"])>
                              <li @class(["list-group-item","p-0"])>
                                <input type="text" name="adresse" id="" class="form-control py-1" value="{{ $interieur->adresse }}">
                              </li>
                            </div>
                            <div @class(["col","mb-1"])>
                            ...
                            <div @class(["col","mb-1"])>
                              <li @class(["list-group-item","p-0"])>
                                <input type="text" name="ville" id="" class="form-control py-1" value="{{ $interieur->ville }}">
                              </li>
                            </div>
                            <div @class(["col","mb-1"])>
                            ...
                            <div @class(["col","mb-1"])>
                              <li @class(["list-group-item","p-0"])>
                                <input type="text" name="pays" id="" class="form-control py-1" value="{{ $interieur->pays }}">
                              </li>
                            </div>
                            <div @class(["col","mb-1"])>
                            ...
                            <div @class(["col","mb-1"])>
                              <li @class(["list-group-item","p-0"])>
                                <input type="text" name="nationalite" id="" class="form-control py-1" value="{{ $interieur->nationalite }}">
                              </li>
                            </div>
                            <div @class(["col","mb-1"])>
                            ...
                            <div @class(["col","mb-1"])>
                              <li @class(["list-group-item","p-0"])>
                                <input type="email" name="email" id="" class="form-control py-1" value="{{ $interieur->email }}">
                              </li>
                            </div>
                            <div @class(["col","mb-1"])>
                            ...
                            <div @class(["col","mb-1"])>
                              <li @class(["list-group-item","p-0"])>
                                <input type="text" name="telephone" id="" class="form-control py-1" value="{{ $interieur->telephone }}">
                              </li>
                            </div>
                            <div @class(["col","mb-1"])>
                            ...
                            <div @class(["col","mb-1"])>
                              <li @class(["list-group-item","p-0"])>
                               <select name="genre" id="" class="form-select form-select-sm">
                                ...
                                <option value="homme" {{ $interieur->genre== "homme" ? 'selected':'' }}>Homme</option>
                                <option value="femme" {{ $interieur->genre== "femme" ? 'selected':'' }}>Femme</option>
                               </select>
                              </li>
                            </div>
                            <div @class(["col","mb-1"])>
                            ...
                            <div @class(["col","mb-1"])>
                              <li @class(["list-group-item","p-0"])>
                                <select name="travail" class="form-select form-select-sm @error('travail') is-invalid @enderror">
                                  ...
                                  <option value="intérieur" {{ $interieur->travail== "intérieur" ? 'selected':'' }} >A l'intérieur de l'agence</option>
                                  <option value="extérieur"  {{ $interieur->travail== "extérieur" ? 'selected':'' }}>A l'extérieur de l'agence</option>
                                  <option value="véhicule"  {{ $interieur->travail== "véhicule" ? 'selected':'' }}>A véhicule de l'agence</option>
                                </select>
                              </li>
                            </div>
                            <div @class(["col","mb-1"])>
                              ...
                              <li @class(["list-group-item","p-0"])>
                                ...
                                <optgroup label="Intérieur" @class(['inter'])>
                                  <optgroup label="Agent">
                                    <option value="Agent de réservation" {{ $interieur->poste == "Agent de réservation" ? "selected":"" }}>Agent de réservation</option>
                                    <option value="Agent de vente voyages" {{ $interieur->poste == "Agent de vente voyages" ? "selected":"" }}>Agent de vente voyages</option>
                                    <option value="Agent de voyage" {{ $interieur->poste == "Agent de voyage" ? "selected":"" }}>Agent de voyage</option>
                                    <option value="Agente de réservation voyages" {{ $interieur->poste == "Agente de réservation voyages" ? "selected":"" }}>Agente de réservation voyages</option>
                                  </optgroup>
                                  <optgroup label="Conseiller">
                                    <option value="Conseiller télévendeur" {{ $interieur->poste == "Conseiller télévendeur" ? "selected":"" }}>Conseiller télévendeur</option>
                                    <option value="Conseiller vendeur" {{ $interieur->poste == "Conseiller vendeur" ? "selected":"" }}>Conseiller vendeur</option>
                                    <option value="Conseillère voyages en ligne" {{ $interieur->poste == "Conseillère voyages en ligne" ? "selected":"" }}>Conseillère voyages en ligne</option>
                                    <option value="Conseillère voyages d'affaires" {{ $interieur->poste == "Conseillère voyages d'affaires" ? "selected":"" }}>Conseillère voyages d'affaires</option>
                                  </optgroup>
                                  <optgroup label="Autre">
                                    <option value="Technicienne de réservation voyages" {{ $interieur->poste == "Technicienne de réservation voyages" ? "selected":"" }}>Technicienne de réservation voyages</option>
                                    <option value="Chef de comptoir en vente de voyages" {{ $interieur->poste == "Chef de comptoir en vente de voyages" ? "selected":"" }}>Chef de comptoir en vente de voyages</option>
                                  </optgroup>
                                </optgroup>
                                <optgroup label="Extérieur" @class(["inter"])>
                                  <option value="Employée de réservation voyages" {{ $interieur->poste == "Employée de réservation voyages" ? "selected":"" }} @class(['text-dark',"text-capitalize"])>Employée de réservation voyages</option>
                                  <option value="Chef du voyage" {{ $interieur->poste == "Chef du voyage" ? "selected":"" }} @class(['text-dark',"text-capitalize"])>Chef du voyage</option>
                                  <option value="Sécritaire" {{ $interieur->poste == "Sécritaire" ? "selected":"" }} @class(['text-dark',"text-capitalize"])>Sécritaire</option>
                                </optgroup>
                                <optgroup label="Véhicule" @class(["inter"])>
                                  <option value="Chauffeur" {{ $interieur->poste == "Chauffeur" ? "selected":"" }} @class(['text-dark',"text-capitalize"])>Chauffeur</option>
                                  <option value="Capitiaine" {{ $interieur->poste == "Capitaine" ? "selected":"" }} @class(['text-dark',"text-capitalize"])>Capitaine</option>
                                </optgroup>
                                </select>
                              </li>
                            </div>
                        ...
                        <div @class(['d-flex','justify-content-between'])>
                          {{-- @if ($interieur->type==="chauffeur")
                          @elseif($interieur->type==="pilote")
                          @endif --}}
                          ...
                          <div @class(['d-flex','justify-content-between'])>
                            ...
                            <button type="button" @class(["btn","btn-sm","waves-effect","waves-light","btn-info"]) data-bs-toggle="modal" data-bs-target=".del{{'-'.$interieur->id }}">
                              <i @class(["mdi","mdi-trash-can"])></i>
                              <span>Supprimer</span>
                            </button>
                          </div>
              ...
              {{-- model delete --}}
              <div class="modal fade del{{'-'.$interieur->id }}" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-md modal-dialog-centered">
                    <div class="modal-content border border-3 border-danger border-solid">
                        ...
                        <div class="modal-body">
                          <form action="{{ route('employe.destroy',$interieur) }}" method="post">
                            @csrf
                            @method("DELETE")
                            <div @class(["text-center","mb-2"])>
                              ...
                              <h6 @class(["m-0","fw-bolder","border","border-solid","border-1","border-danger","rounded-pill","py-2"])>{{ $interieur->name }}</h6>
                            </div>
              ...
              {{-- model show --}}
              <div class="modal fade show{{'-'.$interieur->id }}" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                  <div class="modal-content">
                    <div class="modal-header bg-info py-2">
                        <h5 class="modal-title text-white" id="myExtraLargeModalLabel">Information d'employé : {{ $interieur->name }}</h5>
                        {{-- <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button> --}}
                    </div>
                    <div class="modal-body p-2">
                      <ul @class(["list-group","mb-2"])>
                        <div @class(['row','row-cols-2'])>
                          ...
                          <div @class(["col","ps-0","mb-1"])>
                            <li @class(["list-group-item","py-1","ps-2"])>
                              {{ date('d-m-Y',strtotime($interieur->created_at)) }}
                            </li>
                          </div>
                        </div>
                      </ul>
                      <div @class(['d-flex','justify-content-between'])>
                        ...
                        <div @class(['d-flex','justify-content-between'])>
                          <button type="button" @class(["btn","btn-sm","waves-effect","waves-light","btn-info","me-2"]) data-bs-toggle="modal" data-bs-target=".edit{{'-'.$interieur->id }}">
                            <i @class(["mdi","mdi-pencil" ])></i>
                            <span>Modifier</span>
                          </button>
                          <button type="button" @class(["btn","btn-sm","waves-effect","waves-light","btn-info"]) data-bs-toggle="modal" data-bs-target=".del{{'-'.$interieur->id }}">
              ...
              <div class="modal fade salaire{{'-'.$interieur->id }}" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-xl">
                  <div class="modal-content">
                    <div class="modal-header bg-info py-2">
                        <h5 class="modal-title text-white" id="myExtraLargeModalLabel">Management salaire d'employe : {{ $interieur->name }}</h5>
                    </div>
                    <div class="modal-body p-2">
                                ...
                                <div class="card-body p-2 border border-solid border-2 border-info rounded">
                                  <form action="{{ route('employe-salaire.store') }}" method="post">
                                    ...
                                    <div @class(["row","row-cols-5","mb-2"])>
                                      <div @class(["col"])>
                                       <input type="hidden" name="employe_id" value=" {{ $interieur->id }}">
                      ...
                      <h5 @class(["mt-3","mb-2"])>
                        <button type="button" @class(["btn","btn-sm","waves-effect","waves-light","btn-primary"]) data-bs-toggle="modal" data-bs-target=".edit-salaire{{'-'.$interieur->id }}">
                      ...
                      @foreach ($interieur->salaires as $es)
                        @if (date("Y") == $es->annee)
                          <ul @class(["list-group"])>
                            <li @class(["list-group-item","py-1","ps-2"])>
                      ...
                      @endforeach
                        ...
                        <button type="button" @class(["btn","btn-sm","waves-effect","waves-light","btn-secondary","mt-2"]) data-bs-toggle="modal" data-bs-target=".salaire-annee{{ $interieur->id }}">
              ...
              <div class="modal fade edit-salaire{{'-'.$interieur->id }}" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-xl">
                  <div class="modal-content">
                    <div class="modal-header bg-info py-2">
                        <h5 class="modal-title text-white" id="myExtraLargeModalLabel">Management du salaire d'employé : {{ $interieur->name }}</h5>
                    </div>
                    <div class="modal-body p-2">
                      ...
                      <div @class(["d-flex","justify-content-between","mt-2"])>
                        <button type="button" @class(["btn","btn-sm","waves-effect","waves-light","btn-primary"]) data-bs-toggle="modal" data-bs-target=".salaire{{'-'.$interieur->id }}">
              ...
              {{-- liste salaire annee --}}
              <div class="modal fade salaire-annee{{ $interieur->id }}" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-lg">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      @if ($item->employe_id == $interieur->id)
                          ...
                          <div class="card mb-1 shadow-none">
                              ...
                              <div id="collapse{{ $item->annee }}" class="collapse" aria-labelledby="headingOne" data-bs-parent="#accordion" style="">
                                  <div class="card-body px-0 p-2">
                                    <a href="{{ route('pdf-annee',['id'=>$interieur->id, 'annee'=>$item->annee]) }}" @class(["btn","btn-sm","btn-dark","mb-2","text-white"])>Exporter</a>
                                      <ul @class(["list-group"])>
